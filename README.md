...
Дальше создал сервисный аккаунт чтобы собирать информацию оттуда, таким образом я переношу её уже на сервер в формате json и могу наконец то нормально оперировать хоть чем то.
